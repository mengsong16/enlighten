...
class MLPBCTrainer(SequenceTrainer):
    ...
    def train_one_update(self):
        ...
        # action_targets # (B)
        # goals # (B,goal_dim)
        observations, goals, action_targets, next_observations = self.train_dataset.get_transition_batch(self.batch_size)
    ...
    def train_one_epoch(self, epoch_num, print_logs=False):
        ...
        # accumulate the number of updates
        self.updates_done += batch_num
